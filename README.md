...
ST-Bridgeの規格を作成している [building SMART Japan の構造設計小委員会](https://www.building-smart.or.jp/meeting/buildall/structural-design/) での記載を引用します。
...
+ Unity 2018.4 で開発
+ 対象は ST-Bridge 1.4 (ver2 は非対応です)
+ Windows10で動作を確認しています。

## Contact information

詳細が知りたい場合は以下よりご連絡ください。
